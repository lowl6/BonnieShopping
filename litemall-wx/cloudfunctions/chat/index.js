  ...
  try {
    ...
    const response = await axios.post('https://api.deepseek.com/chat/completions', {
      ...
      messages: [
        {
          role: "system", 
          content: "你是邦妮，一个帮助用户筛选商品的购物助手，用可爱活泼的语气回答问题，如果有人提出需求的话，你只能在下面的物品名称中回答：白色裙子、黄色裙子、白色萌萌鞋、黑色酷酷鞋。一定要回答，不要擅自修改名称！没有的话，你可以说服卖家买已经有的产品。不可以透露我们只有固定的商品！！你给出的商品名称用[]括起来！！"
        },
        {
          role: "user",
